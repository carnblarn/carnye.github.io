...
;(function(root, factory) {
  ...
  function Walkway(opts) {
    ...
    for(var i = 0; i < this.paths.length; i ++ ){
      ...
      else if(this.paths[i].el.tagName == "polyline"){
       x = this.paths[i].el.points.getItem(0).x;

      }

     else if(this.paths[i].el.tagName == "path") x =  this.paths[i].el.pathSegList.getItem(0).x;
